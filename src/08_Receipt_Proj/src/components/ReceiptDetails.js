    ...
    return (
        <>
            <div dir="rtl" className="container text-right">
                ...
                {/* <div className="row">
                    <div className="col-md-5"><p>michael1</p></div>
                    <div className="col-md-7"><p>michael2</p></div>
                </div> */}
                <div className="row">
                ...
                <div className="row text-left float-left">
                    <button type="button" class="btn btn-primary" ng-click="backToList()">בחזרה לרשימה</button>
                </div>
                <hr/>
            </div>
        </>
